    ...
    >
      ...
      >
       ...
       <v-col  
        cols="4"
      >
      <v-img class="logo_iso2" src="https://wewatch.ae/wp-content/uploads/2021/02/Logo-ISO-18788-440.jpg"></v-img>
       </v-col>
      ...
      <v-col
        ...
        class="float-right"
      >
      <v-img class="logo_iso3" src="https://wewatch.ae/wp-content/uploads/2021/02/Logo-ISO-9001-14001-ISO-45001-440.jpg"></v-img>
...
<!-- section 2 -->
    ...
    <v-row>
       ...
       <v-col
        ...
        >
      <h2 class="top_h">Daily Safety and Security Report</h2><br>
      ...
      <ul class="top_listing">
        <li>John Harris</li>
        <li>Director QHSSE</li>
        <li>UAE: +971 52 216 3038</li>
        <li>KSA: +966 50 604 2270</li>
      </ul>  
...
<br>
      ...
      <p class="" style="color:red;">Confidential </p>
       ...
       <p class="">Prepared by WeWatch FZ LLC</p>
...
<br>
     ...
     <v-row>
      ...
      <h2 class="">10.	Security Management Plan and Sub-Contractor Security  <span style="color:red"> (Sec)</span> </h2>
      <p class="">10.1	No immediate changes to the current security plan.  Weekly review to be conducted in the next 48hr period, all changes will be added to the revised plan and reported in the daily safety and security report, no immediate concerns. Two sub-contractor guards dismissed for security violations, both were replaced by the sub-contractor management within a 2-hr period, no further concerns.</p>
    ...
    <br>
     ...
     <v-row>
      ...
      <h2 class="">11.	Country Travel Security 	<span style="color:red"> (Sec) </span> </h2>
      <p class="">11.1	Authorities are requiring all non-Saudis, except for children aged eight and under, to present a negative coronavirus disease (COVID-19) test to travel to Saudi Arabia as of Jan. 5.</p>
     ...
     <v-row>
      ...
      <h2 class="">13.	Procurement Request 	<span style="color:red"> (Operational HSE or Security Equipment Requirement) (Both) </span> </h2>
      <p class="">13.1	Nothing to report.</p>
     ...
     <v-row>
      ...
      <h2 class="">14.	Red Flag 	<span style="color:red"> (Both) </span> </h2>
      <p class="">14.1	Nothing to report. </p>
